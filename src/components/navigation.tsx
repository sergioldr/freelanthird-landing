...
export default function Navigation({ children, lang }: NavigationProps) {
          ...
          <>
            ...
            >
              <div className="fixed bottom-20 sm:bottom-32 left-4 sm:left-8 flex flex-col items-start justify-center gap-4">
                <MobileLink href={`${langPrefix}/projects`}>
                  {t("nav.projects")}
                </MobileLink>

                <MobileLink href={`${langPrefix}/about`}>
                  <svg
                ...
                <MobileLink href={`${langPrefix}/contact`}>
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    width="32"
                    height="32"
